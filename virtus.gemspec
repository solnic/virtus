...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "spec/unit/virtus/typecast/fixnum/class_methods/to_decimal_spec.rb",
    "spec/unit/virtus/typecast/fixnum/class_methods/to_float_spec.rb",
    "spec/unit/virtus/typecast/fixnum/class_methods/to_string_spec.rb",
    "spec/unit/virtus/typecast/float/class_methods/to_decimal_spec.rb",
    "spec/unit/virtus/typecast/float/class_methods/to_integer_spec.rb",
    ...
    "spec/unit/virtus/typecast/string/class_methods/to_datetime_spec.rb",
    "spec/unit/virtus/typecast/string/class_methods/to_decimal_spec.rb",
    "spec/unit/virtus/typecast/string/class_methods/to_float_spec.rb",
    "spec/unit/virtus/typecast/string/class_methods/to_integer_spec.rb",
    "spec/unit/virtus/typecast/string/class_methods/to_time_spec.rb",
    "spec/unit/virtus/typecast/symbol/class_methods/to_string_spec.rb",
    "spec/unit/virtus/typecast/true_class/class_methods/to_string_spec.rb",
